	...
	return (
		<section className="relative flex flex-1 flex-col items-center px-6 pt-8 md:pt-12">
			...
			<div className="relative z-10 flex w-full flex-col items-center">
				...
				>
					<span>Now with eERC Privacy Support</span>
				...
				>
					Enforce validator and user rules by region with built-in KYC, geofencing, and license requirements. Keep data private within permissioned sets using eERC.
				</motion.p>
